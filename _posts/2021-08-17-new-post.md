...
```
 ...
 But such as R-squared is 0.29 or 29% that means that only 29% of the variability in Happiness Score is explained by difference in Total Alcohol Per Capita.
